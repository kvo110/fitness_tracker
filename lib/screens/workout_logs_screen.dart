...
class _WorkoutLogsScreenState extends State<WorkoutLogsScreen>
  ...
  Future<void> _editWorkout(int index) async {
    ...
    final durationCtrl = TextEditingController(
      text: row['duration']?.toString() ?? '',
    );
    String? rpe = (row['rpe']?.toString().isNotEmpty ?? false)
        ? row['rpe'].toString()
        : null;
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              'Date: ${DateTimeFormatter.format(editedDateTime)}',
                            ),
                            TextButton(
                              onPressed: () async {
                          ...
                          onPressed: () async {
                            ...
                            if ((nameCtrl.text).trim().isEmpty ||
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Please fill exercise, sets, and reps.',
                                  ),
